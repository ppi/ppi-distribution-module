 ...
 * are necessary to run the PPI skeleton app.
 *
 * @author Tobias Schultze <http://tobion.de>
...
class FrameworkRequirements extends RequirementCollection
{
    ...
    public function __construct()
    {
        ...
        $this->addRequirement(
            ...
            sprintf('You are running PHP version "<strong>%s</strong>", but PPI needs at least PHP "<strong>%s</strong>" to run.
                Before using PPI, upgrade your PHP installation, preferably to the latest version.',
        ...
        $this->addRequirement(
            ...
            'PHP version must not be 5.3.16 as PPI won\'t work properly with it',
        ...
        $this->addRecommendation(
            file_get_contents(__FILE__) === file_get_contents(__DIR__.'/../vendor/sensio/distribution-bundle/NoiseLabs/Module/DistributionBundle/resources/skeleton/app/FrameworkRequirements.php'),
        ...
        if (null !== $pcreVersion) {
            $this->addRecommendation(
                ...
                '<strong>PCRE 8.0+</strong> is preconfigured in PHP since 5.3.2 but you are using an outdated version of it. PPI probably works anyway but it is recommended to upgrade your PCRE extension.'
            );
        }
